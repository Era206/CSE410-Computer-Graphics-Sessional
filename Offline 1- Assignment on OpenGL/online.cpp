...
GLdouble vertex1x=1.0/3,vertex1y=1.0/3,vertex1z=1.0/3,vertex2x=1.0/3,vertex2y=1.0/3,vertex2z=1.0/3,vertex3x=1.0/3,vertex3y=1.0/3,vertex3z=1.0/3;
...
void keyboardListener(unsigned char key, int x, int y) {
	...
	switch(key){
        ...
        rotateAngle+=10;
            rotateAngle%=360;
            translateZ+=rotateAngle*sphereRadius*M_PI/180;
            break;
